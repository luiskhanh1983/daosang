...
namespace Nop.Web.Models.Customer
{
    ...
    public partial class CustomerInfoModel : BaseNopModel
    {
        ...
        {   
           ...
           // this.AvailableSharingPartnerLevels = new List<SelectListItem>();
            this.AvailableSharingPartnerLevels = new List<SelectListItem>();
        }
        [NopResourceDisplayName("Account.Fields.PartnerID")]
        [AllowHtml]
        public string PartnerID { get; set; }

        [NopResourceDisplayName("Account.Fields.SharingPartnerLevel")]
        [AllowHtml]
        public int SharingPartnerLevel { get; set; }
        public IList<SelectListItem> AvailableSharingPartnerLevels { get; set; }
        ...
        [NopResourceDisplayName("Account.Fields.TaxID")]
        [AllowHtml]
        ...
        [NopResourceDisplayName("Account.Fields.Facebook")]
        [AllowHtml]
      
        public string Facebook { get; set; }
        [NopResourceDisplayName("Account.Fields.FanPage")]
        [AllowHtml]
        public string FanPage { get; set; }

        [NopResourceDisplayName("Account.Fields.Twitwer")]
        [AllowHtml]
        public string Twitwer { get; set; }
        [NopResourceDisplayName("Account.Fields.Skype")]
        [AllowHtml]
