...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BaseNopController
    {
        ...
        public ActionResult HeaderLinks()
        {
            ...
            if (cart.Count > 0)
            {
                var _orderTotalCalculationService = Nop.Core.Infrastructure.EngineContext.Current.Resolve<IOrderTotalCalculationService>();
                var _priceFormatter = Nop.Core.Infrastructure.EngineContext.Current.Resolve<IPriceFormatter>();
                //subtotal
            ...
            var model = new HeaderLinksModel()
            {
                ...
                ShoppingCartItems = cart //Custom Code
                    .GetTotalProducts(),
                ...
                CountUnreadMessage=unreadMessageCount,
