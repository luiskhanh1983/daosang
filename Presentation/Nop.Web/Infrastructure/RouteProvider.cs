...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //BeYoung
            routes.MapLocalizedRoute("BeYoung",
                        "BeYoung",
                        new { controller = "BeYoung", action = "Index" },
                        new[] { "Nop.Web.Controllers" });

            //Webinars
            routes.MapLocalizedRoute("Webinars",
                    "Webinars",
                    new { controller = "Webinars", action = "Index" },
                    new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CustomerAvatar",
                            "customer/image",
                            new { controller = "Customer", action = "Image" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("Search",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //SHARING PARTNER DETAILS
            routes.MapLocalizedRoute("BeYoungTOTALHEALTH",
                            "BeYoungTOTALHEALTH",
                            new { controller = "Customer", action = "BeYoungTOTALHEALTH" },
                            new[] { "Nop.Web.Controllers" });
            //SOCIAL
            routes.MapLocalizedRoute("Social",
                              "Social",
                              new { controller = "Customer", action = "Social" },
                              new[] { "Nop.Web.Controllers" });
            //private messages
