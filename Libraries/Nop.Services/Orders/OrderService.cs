...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual IList<OrderItem> GetOrderItemsFromProductId(int productId)
        {
            return _orderItemRepository.Table.Where(x => x.ProductId == productId && x.Order.OrderStatusId == (int)(OrderStatus.Complete)).ToList();


        }
        public virtual IList<OrderItem> GetOrderItemsFromProductIdWithAllStatus(int productId)
        {
            return _orderItemRepository.Table.Where(x => x.ProductId == productId).ToList();
        }
        /// <summary>
