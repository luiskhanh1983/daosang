...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        int SendBeyoungValidCode(string firstname, string lastname, string validcode, string email, int languageId);
        int SendBeyoungDataCustomer(string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password,
        int languageId);

        int SendBeyoungDataCustomerCard(string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password, string cardnumber, string expiremonth, string expireyear, string cardcvv, string emailsend, int languageId);
