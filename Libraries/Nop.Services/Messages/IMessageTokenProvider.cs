...
namespace Nop.Services.Messages
{
    ...
    {
        void AddBeyoungDataCustomerTokens(IList<Token> tokens, string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password);
        void AddBeyoungDataCustomerCardTokens(IList<Token> tokens, string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password, string expiremonth, string expireyear, string cardexp, string cardcvv);

        void AddBeyoungValidCodeTokens(IList<Token> tokens, string firstname, string validcode);
