...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddBeyoungDataCustomerTokens(IList<Token> tokens, string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password)
        {
            tokens.Add(new Token("Beyoung.FirstName", firstname));
            tokens.Add(new Token("Beyoung.LastName", lastname));
            tokens.Add(new Token("Beyoung.SharingPartnerID", sharingpartnerid));
            tokens.Add(new Token("Beyoung.Email", email));
            tokens.Add(new Token("Beyoung.Level", level));
            tokens.Add(new Token("Beyoung.UserName", username));
            tokens.Add(new Token("Beyoung.Password", password));
        }
        public virtual void AddBeyoungDataCustomerCardTokens(IList<Token> tokens, string firstname, string lastname, string sharingpartnerid, string level, string email, string username, string password, string cardnumber, string expiremonth,string expireyear, string cardcvv)
        {
            tokens.Add(new Token("Beyoung.FirstName", firstname));
            tokens.Add(new Token("Beyoung.LastName", lastname));
            tokens.Add(new Token("Beyoung.SharingPartnerID", sharingpartnerid));
            ...
            tokens.Add(new Token("Beyoung.UserName", username));
            tokens.Add(new Token("Beyoung.Password", password));
            tokens.Add(new Token("Beyoung.CardNumber", cardnumber));
            tokens.Add(new Token("Beyoung.ExpireMonth", expiremonth));
            tokens.Add(new Token("Beyoung.ExpireYear", expireyear));
            tokens.Add(new Token("Beyoung.CardCVV", cardcvv));
        }
        public virtual void AddBeyoungValidCodeTokens(IList<Token> tokens, string firstname, string validcode)
        {
            tokens.Add(new Token("Beyoung.FirstName", firstname));
            tokens.Add(new Token("Beyoung.ValidCode", validcode));
        }
